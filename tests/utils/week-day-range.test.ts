...
test("LocalTime.parse rejects invalid strings", () => {
...
test("LocalTime counts num of days correctly", () => {
...
test("LocalTime gets day by index correctly", () => {
...
test("LocalTime includes behaves correctly", () => {
